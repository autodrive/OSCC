...
fn main() {
    ...
    let _ = bindgen::builder()
        ...
        .whitelisted_function("update_steering")
        ...
        .whitelisted_var("OSCC_REPORT_CHASSIS_STATE_2_CAN_ID")
        .whitelisted_var("TORQUE_MAX_IN_NEWTON_METERS")
        .whitelisted_var("CAN_STANDARD")
        .whitelisted_var("CAN_MSGAVAIL")
        .whitelisted_var("STEPS_PER_VOLT")
        .whitelisted_var("SPOOF_LOW_SIGNAL_CALIBRATION_CURVE_SCALAR")
        .whitelisted_var("SPOOF_LOW_SIGNAL_CALIBRATION_CURVE_OFFSET")
        .whitelisted_var("SPOOF_HIGH_SIGNAL_CALIBRATION_CURVE_SCALAR")
        .whitelisted_var("SPOOF_HIGH_SIGNAL_CALIBRATION_CURVE_OFFSET")
        .whitelisted_var("STEPS_PER_VOLT")
        .whitelisted_var("PID_WINDUP_GUARD")
        .whitelisted_var("PID_PROPORTIONAL_GAIN")
        .whitelisted_var("PID_INTEGRAL_GAIN")
        .whitelisted_var("PID_DERIVATIVE_GAIN")
        .whitelisted_var("g_steering_control_state")
        .whitelisted_var("g_pid")
        .whitelisted_var("g_control_can")
        .whitelisted_var("g_spoofed_torque_output_sum")
        .whitelisted_type("oscc_report_chassis_state_2_data_s")
        .whitelisted_type("oscc_report_chassis_state_2_s")
